...
function fioGeneratePlots () {
    ...
    DEFAULT_SOURCE='set label 30 "Fio data" font "Helvetica,14" tc rgb "#00000f" at screen 0.976,0.175 right'
...
sudo ./ceph_disk_test.sh /dev/sdb 1024m 4m 30 journal firsttest